...
#data_cv_path = "./data/TCGA_GBMLGG/splits/gbmlgg15cv_all_st_0_0_0.pkl"
data_cv_path = "./data/TCGA_GBMLGG/splits/gbmlgg15cv_all_st_COMPASS12_nogradem1.pkl"
...
#data_cv_path = os.path.join(opt.dataroot, 'splits', 'gbmlgg_small_all_st_0_0_0.pkl')




print("Loading %s" % data_cv_path)
print("DEBUG data_cv_path:", data_cv_path)
...
all_splits = list(data_cv_splits.items())
for k, data in all_splits[:1]:  
	print("*******************************************")
